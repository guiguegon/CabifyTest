...
public class LocationUtils {
    ...
    public static LatLngBounds getLatLngBounds(List<Marker> markers) {
    ...
    public static LatLngBounds getUserLatLngBounds(Location userLocation) {
        ...
        LatLngBounds latLngBounds = new LatLngBounds.Builder().include(
                SphericalUtil.computeOffset(latLng, USER_LOCATION_RADIUS, 0))
    ...
    public static String getFullAddress(Marker marker) {
        if (marker.hasAddress()) {
            return getFullAddress(marker.getAddress());
        } else {
